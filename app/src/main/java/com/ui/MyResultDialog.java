...
public class MyResultDialog extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (AppContext.device == "phone") {
            ...
            //useName1
            setPosi(useName1, "胖胖", Color.YELLOW, 0.653, 0.152);//169
            //useName2
            setPosi(useName2, "胖胖", Color.WHITE, 0.653, 0.607);//5007
            //useName2.setTextSize(textSize-5);

            //textViewLine1
            setPosi(textViewLine1, "Line", Color.YELLOW, 0.653, 0.208);//1868
            //textViewLine2
            setPosi(textViewLine2, "Line", Color.WHITE, 0.653, 0.664);//4617

			//face1
			RelativeLayout.LayoutParams paramsN1 = new RelativeLayout.LayoutParams((int) (screenWidth * 0.18), (int) (screenWidth * 0.18));
			paramsN1.setMargins((int) (screenWidth * 0.15), (int) (screenWidth/0.97*0.24), 0, 0);//2067
			...
			paramsN2.setMargins((int) (screenWidth * 0.15), (int) (screenWidth/0.97*0.69), 0, 0);//534
			face2.setLayoutParams(paramsN2);

            //textViewfast1.
            setPosi(textViewfast1, "00:00:000", Color.YELLOW, 0.653, 0.389);
            //textViewfast2
            setPosi(textViewfast2, "00:00:000", Color.WHITE, 0.653, 0.848);

            //imageViewTui1
            RelativeLayout.LayoutParams paramsN = new RelativeLayout.LayoutParams((int) (screenWidth * 0.14), (int) (screenWidth * 0.13));
            paramsN.setMargins((int) (screenWidth * 0.653), (int) (screenWidth/0.97 * 0.225), 0, 0);
            ...
            paramsM.setMargins((int) (screenWidth * 0.653), (int) (screenWidth/0.97 * 0.68), 0, 0);
            imageViewTui2.setLayoutParams(paramsM);
            //imageViewTui2.setVisibility(View.VISIBLE);


            //textViewTime1
            setPosi(textViewTime1, "00:00:000", Color.YELLOW, 0.653, 0.27);//2488
            //textViewTime2
            setPosi(textViewTime2, "00:00:000", Color.WHITE, 0.653, 0.727);

            //textViewLap1
            setPosi(textViewLap1, "99", Color.YELLOW, 0.653, 0.327);//2887
            //textViewLap2
            setPosi(textViewLap2, "99", Color.WHITE, 0.653, 0.783);

            if (AppContext.lanuage) {//zh
                result_r.setBackgroundResource(R.drawable.bg_result_race);
                findViewById(R.id.center_end110).setBackgroundResource(R.drawable.bg_mid_race_result);
                findViewById(R.id.iv_result_race_logo).setBackgroundResource(R.drawable.logo);

                imageback.setBackgroundResource(R.drawable.back_btn);
                imageShare.setBackgroundResource(R.drawable.share);
            } else {
                result_r.setBackgroundResource(R.drawable.bg_result_race_e);
                findViewById(R.id.center_end110).setBackgroundResource(R.drawable.bg_mid_race_result_e);
                findViewById(R.id.iv_result_race_logo).setBackgroundResource(R.drawable.logo2);
            ...
            imageShare.setLayoutParams(paramsjk);
            //useName1
            setPosi(useName1, "胖胖", Color.YELLOW, 0.653, 0.169);
            useName1.setTextSize(textSize - 5);

            //textViewLine1
            setPosi(textViewLine1, "Line", Color.YELLOW, 0.653, 0.206);//


            //textViewfast1
            setPosi(textViewfast1, "00:00:000", Color.YELLOW, 0.653, 0.3285);
            //textViewfast2
            setPosi(textViewfast2, "00:00:000", Color.WHITE, 0.653, 0.657);//0.652

            //imageViewTui1
            RelativeLayout.LayoutParams paramsN = new RelativeLayout.LayoutParams((int) (screenWidth * 0.14), (int) (screenWidth * 0.13));
            paramsN.setMargins((int) (screenWidth * 0.653), (int) (screenHeight * 0.223), 0, 0);
            imageViewTui1.setLayoutParams(paramsN);
            //imageViewTui1.setVisibility(View.VISIBLE);
            //imageViewTui2
            RelativeLayout.LayoutParams paramsM = new RelativeLayout.LayoutParams((int) (screenWidth * 0.14), (int) (screenWidth * 0.13));
            paramsM.setMargins((int) (screenWidth * 0.653), (int) (screenHeight * 0.5446), 0, 0);
            imageViewTui2.setLayoutParams(paramsM);
            //imageViewTui2.setVisibility(View.VISIBLE);
            //face1
            RelativeLayout.LayoutParams paramsN1 = new RelativeLayout.LayoutParams((int) (screenWidth * 0.18), (int) (screenWidth * 0.18));
            ...
            //textViewTime1
            setPosi(textViewTime1, "00:00:000", Color.YELLOW, 0.653, 0.2488);


            //textViewLap1
            setPosi(textViewLap1, "99", Color.YELLOW, 0.653, 0.2887);
            //textViewLap2
            setPosi(textViewLap2, "99", Color.WHITE, 0.653, 0.617);//612

            if (AppContext.lanuage) {//zh

                //useName2
                setPosi(useName2, "胖胖", Color.WHITE, 0.653, 0.498);//493
                useName2.setTextSize(textSize - 5);

                //textViewLine2
                setPosi(textViewLine2, "Line", Color.WHITE, 0.653, 0.5366);//5316

                //textViewTime2
                setPosi(textViewTime2, "00:00:000", Color.WHITE, 0.653, 0.577);//572
                ...
                //useName2
                setPosi(useName2, "胖胖", Color.WHITE, 0.653, 0.494);//493
                useName2.setTextSize(textSize - 5);

                //textViewLine2
                setPosi(textViewLine2, "Line", Color.WHITE, 0.653, 0.5316);//5316

                //textViewTime2
                setPosi(textViewTime2, "00:00:000", Color.WHITE, 0.653, 0.572);//572
    ...
    private void setPosi(TextView textView, String string, int colors, Double leftPer, Double topPer) {
        ...
        params1.setMargins((int) (screenWidth * leftPer), (int) (screenWidth/0.97 * topPer), 0, 0);
