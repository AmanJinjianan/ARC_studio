...
public class LightDialog extends ProgressDialog {
	...
	private void init() {
		...
		final ScaleAnimation animation = new ScaleAnimation(0.0f, 7f, 0.0f, 7f,
		...
		FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(
				(int) (screenWidth * 0.38),
				(int) (screenWidth * 0.14));//346
		params.setMargins((int) (screenWidth * 0.31),
				(int) (screenHeight * 0.83), 0, 0);
		light_logo.setLayoutParams(params);

		if (AppContext.device == "phone") {
			
			FrameLayout.LayoutParams paramX = new FrameLayout.LayoutParams(
			...
			FrameLayout.LayoutParams params0 = new FrameLayout.LayoutParams((int) (screenWidth * 0.2), (int) (screenWidth * 0.2));
			...
			setPosi(greenOne, 0.122, 0.36, 1);//337
			setPosi(greenTwo, 0.311, 0.36, 1);//34
			setPosi(greenThree, 0.497, 0.36, 1);
			setPosi(greenFour, 0.685, 0.36, 1);
